...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tablePlot = QtWidgets.QTableWidget(self.gridLayoutWidget)
        self.tablePlot.setObjectName("tablePlot")
        self.tablePlot.setColumnCount(0)
        self.tablePlot.setRowCount(0)
        self.gridLayout.addWidget(self.tablePlot, 1, 0, 1, 1)
